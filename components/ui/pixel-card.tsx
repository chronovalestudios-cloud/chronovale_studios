...
const VARIANTS = {
  ...
  gold: { // Custom South Indian Theme colors
    activeColor: '#fef08a',
    gap: 4,
    speed: 25,
    colors: '#D4A017,#FF6B00,#8B4513,#FFE699', // Saffron, Gold, Ember
    noFocus: false
  }
};
...
export function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }: PixelCardProps) {
