    ...
    <section className="relative py-32 px-6 md:px-12 lg:px-20 overflow-hidden" ref={ref}>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-orbitron)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-[0.1em] uppercase leading-tight mb-6">
            A New Chapter in{' '}
            <span className="text-primary text-glow-subtle">Interactive Narrative</span>{' '}
            is Coming...
          </h2>
          ...
          >
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-12 h-12 border border-border rounded-full flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors duration-300 group"
